...
**game engine.ulackroad.io** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
## Getting Started
```bash
git clone https://github.com/BlackRoad-Interactive/game-engine.blackroad.io.git
cd game-engine.blackroad.io
```
